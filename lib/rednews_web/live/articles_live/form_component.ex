defmodule RednewsWeb.ArticlesLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        />
        <:actions>
          <.button class="bg-zinc-600" phx-disable-with="Saving...">Save Articles</.button>
        </:actions>
      </.simple_form>
    </div>
    """
  ...
  defp ensure_author(params, author_id) do
    if is_nil(params["author"]), do: Map.put(params, "author", author_id), else: params
  end
