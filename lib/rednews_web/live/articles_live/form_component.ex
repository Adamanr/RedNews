  ...
  def render(assigns) do
    ...
    <div class="bg-white p-5 rounded-lg">
      ...
      >
        ...
        <.input field={@form[:header]} type="text" label="Картинка (URL)" />


        <div class="hidden">
          <.input field={@form[:user_id]} value={assigns.current_user.id} type="number" label="Пользователь" />
        </div>
        ...
        <:actions>
          <div class="flex w-full">
            ...
            <.button class="bg-zinc-600 text-white font-bold flex-end" phx-disable-with="Saving...">Сохранить</.button>
          </div>
        </:actions>
      </.simple_form>
